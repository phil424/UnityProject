...
{
    public class VerticesStat : IStatProvider, IDisposable
    {
        public string Id => "vertices";
        public string Label => "VERTS";
        ...
        public VerticesStat(float optimalValue, float warningValue)
        {
            _profilerRecorder = ProfilerRecorder.StartNew(ProfilerCategory.Render, "Vertices Count");

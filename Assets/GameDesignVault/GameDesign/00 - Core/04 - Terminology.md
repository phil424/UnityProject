...
This document defines the canonical meaning of project terminology.

When implementation names and design terms differ, record the distinction here
rather than allowing several meanings for the same word.

## Ability

A player-activatable combat behaviour that exists independently of the system
that grants it.
